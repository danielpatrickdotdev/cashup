...
urlpatterns = [
    ...
    url(r'^staff/(?P<username>[\w.@+-]+)/$',
        views.PersonnelDetailView.as_view(),
        name='cashup_personnel_detail'),
    url(r'^staff/(?P<username>[\w.@+-]+)/edit/$',
        views.PersonnelUpdateView.as_view(),
        name='cashup_personnel_update'),
    ...
    url(r'^outlets/(?P<slug>[\w.@+-]+)/close-till/$',
